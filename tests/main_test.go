...
var _ = Describe("coachwise Test Suite", func() {
	...
	Context("Packages", packagesGroup)
	Context("AssessmentTests", assessmentTestsGroup)
	Context("Schedules", schedulesGroup)
	Context("Sessions", sessionsGroup)
	Context("Connections", connectionsGroup)
	Context("CoachApplications", coachApplicationsGroup)
